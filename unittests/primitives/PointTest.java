...
public class PointTest {
    ...
    public void testAdd() {
        ...
        Point p2 = new Point(2, 4, 6);
        assertTrue(p1.add(v1).equals(p2),"ERROR: (point + vector) = other point does not work correctly");
        assertTrue(p1.add(v1Opposite).equals(Point.ZERO), "ERROR: (point + vector) = center of coordinates does not work correctly");
    }
